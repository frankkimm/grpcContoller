package de.kimmlingen.github.contributors

import de.kimmlingen.github.Repo
...
//        throw RuntimeException("Failed loading contributors for ${repo.name} with response '${response.code()}: ${response.message()}'")
    } else {
